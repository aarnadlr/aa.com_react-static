  ...
  <div className="">
    ...
    <div id="topSection" className="flex flex-column center white mt6 mb5">
      ...
      <Paragraph className="f5 lh-copy4 mh3">
        Hi there. I’m a UI designer / Front-end developer in NYC. I’ve worked on
        ...
        Times. My focus is on <span className="bg-green8">&nbsp;UI design&nbsp;</span> , <span className="bg-teal8">&nbsp;React&nbsp;</span> , <span className="bg-cyan8">&nbsp;javascript&nbsp;</span> and <span className="bg-blue6">&nbsp;coded
        animation&nbsp;</span>.
      </Paragraph>
    </div>
